...
public class UtilsManager extends UtilsAdmob {
    ...
    private void share(){
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT,
                activity.getResources().getString(R.string.app_name)+"\n" +
                        ...
                        "https://play.google.com/store/apps/developer?id=G.+Vignesh+B.E" + activity.getApplication().getPackageName()
        );
    ...
    private void rate(){
        ...
        try {
            ...
            activity.startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("https://play.google.com/store/apps/developer?id=" + activity.getApplication().getPackageName())));
        }
    }
    ...
    private  void more_games(){
        try {
            activity.startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("https://play.google.com/store/apps/developer?id=G.+Vignesh+B.E" + activity.getApplication().getPackageName())));
        }
        catch (Exception e){
